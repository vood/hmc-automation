...
#    }
  ...
  exec { 'compile and install':
    command => 'cd /tmp/ibm_db2-1.9.5 && /usr/bin/phpize --clean && /usr/bin/phpize && ./configure --with-IBM_DB2=/opt/ibm/db2/V10.5 && /usr/bin/make && /usr/bin/make install',
    path => '/tmp/ibm_db2-1.9.5'
  }
